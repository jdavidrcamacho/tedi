...
class GP(object):
    ...
    def log_likelihood(
        self, kernel=None, mean=None, nugget=False, shift=False, separate=False
    ):
        """
    ...
    def marginalLikelihood(
        self, kernel1=None, mean=None, jitter=None, N=1000, file="saved_results.txt"
    ):
        f = open(file, "a")
        m = mean(self.time)
...
class TP(object):
    ...
    def log_likelihood(self, kernel, degrees, mean=False, nugget=False, shift=False):
        """
