...
# Gaussian processes
gpOBJ = gaussian_process.CreateProcess(k, m, time, y, yerr)  # type: ignore
...
# Student-t processes
tpOBJ = student_process.CreateProcess(k, 5, m, time, y, yerr)

tp_loglike = tpOBJ.log_likelihood(k, 5)
